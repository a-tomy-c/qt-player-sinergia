...
class Ui_Player(object):
    def setupUi(self, Player):
        ...
        self.btPin.setMinimumSize(QSize(35, 35))
        self.btPin.setMaximumSize(QSize(35, 35))
        ...
        self.btPin.setIconSize(QSize(19, 30))
        ...
        self.btMax.setMinimumSize(QSize(35, 35))
        self.btMax.setMaximumSize(QSize(35, 35))
        ...
        self.btMin.setIconSize(QSize(19, 30))
        ...
        self.btClose.setMinimumSize(QSize(35, 35))
        self.btClose.setMaximumSize(QSize(35, 35))
        ...
        self.btClose.setIconSize(QSize(19, 30))
        ...
        self.lnBuscar.setMinimumSize(QSize(16777215, 30))
        ...
        icon9 = QIcon()
        icon9.addFile(u":/skip-back.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btBack.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/play.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btPlay.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/stop.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btStop.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/skip-forward.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btForward.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/eject.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btEject.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/shuffle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btShuffle.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/repeat.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btRepeat.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/menu.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btLista.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/setting.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btSetting.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/volume-medium.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btVolumen.setIcon(icon18)
        self.btVolumen.setIconSize(QSize(30, 30))
